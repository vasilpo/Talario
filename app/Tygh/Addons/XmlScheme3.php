...
class XmlScheme3 extends XmlScheme2
{
    ...
    /**
     * Gets built-in license number of an add-on downloaded from the Marketplace.
     *
     * @return string|null
     */
    public function getMarketplaceLicenseNumber()
    {
        return isset($this->_xml->marketplace_license_number) ? (string) $this->_xml->marketplace_license_number : null;
    }

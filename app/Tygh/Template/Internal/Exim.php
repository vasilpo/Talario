...
/**
 * The class that implements the logic of import and export of on-site notification templates.
 *
...
class Exim
{
    ...
    /**
     * On-site notification templates export/import constructor.
     *
     * @param Service           $service            Instance of on-site notification templates service.
    ...
    /**
     * Import on-site notification templates from xml file.
     *
    ...
    /**
     * Import on-site notification templates from xml.
     *
    ...
    /**
     * Import on-site notification templates from data.
     *
    ...
    /**
     * Import on-site notification template from data.
     *
    ...
    /**
     * Export all on-site notification templates to xml.
     *
     * @return string
     */
    ...
    /**
     * Export on-site notification templates to xml.
     *
     * @param Template[]    $templates  List of on-site notification template instances.
    ...
    public function exportToXml($templates, $snippets)
    {
        ...
        $xml_root = new ExSimpleXmlElement('<internal_templates></internal_templates>');
    ...
    /**
     * Export on-site notification templates to data.
     *
     * @param Template[]    $templates  List of on-site notification template instances.
     * @param Snippet[]     $snippets   List of snippet instances.
     *
    ...
    /**
     * Export on-site notification template to data.
     *

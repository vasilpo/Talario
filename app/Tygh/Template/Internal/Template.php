...
/**
 * The entity class of an on-site notification template.
 *
...
class Template implements ITemplate
{
    ...
    public function getName()
    {
        if ($this->name === null) {
            ...
            /**
             * Allows to change the name of the on-site notification template.
             *
             * @param Template  $this   Instance of on-site notification template.
             * @param string    $result Current template name.
             */
            fn_set_hook('template_internal_get_name', $this, $result);
            $this->name = $result;
        }
    ...
    {
        return 'internal_template.' . $this->code;
    }
    ...
    /**
     * Instantiate on-site notification template from array.
     *
     * @param array $data
     *
     * @return Template
    ...
    /**
     * Load on-site notification template from array.
     *
     * @param array $data
     */
    ...
    /**
     * Convert on-site notification template instance to array.
     *
    ...
    public function getPreparedParamsSchema()
    {
        ...
        if (!empty($this->params_schema)) {
            fn_get_schema('internals', 'variants.functions');

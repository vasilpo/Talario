...
class Payments extends AEntity
{
    ...
    public function update($id, $params)
    {
        ...
        if (isset($params['processor_params']['certificate_key_filename']) && !$params['processor_params']['certificate_key_filename']) {
            fn_rm(Registry::get('config.dir.certificate_keys') . $id);
        }

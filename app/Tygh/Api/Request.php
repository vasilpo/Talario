...
class Request
{
     ...
     */
    protected function getMethodFromRequestHeaders(): string
    {
        if ($_SERVER['REQUEST_METHOD'] === 'POST' && !empty($_REQUEST['_METHOD'])) {
     ...
     *
     * @return array{Content-Type: string, Accept: string} Content type
     */

...
if (defined('PAYMENT_NOTIFICATION')) {
    ...
    */
    ...
    $amount = ($currency === '978')
        ? (string) ($order_info['total'] * 100)
        : (string) $order_info['total'];

    $url_merchant = fn_url('payment_notification.result?payment=servired&order_id=' . $order_id . $postfix, SiteArea::STOREFRONT, 'http');

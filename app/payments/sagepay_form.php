...
if (defined('PAYMENT_NOTIFICATION')) {
    ...
    if ($processor_data['processor_params']['testmode'] == 'Y') {
        $post_address = 'https://sandbox.opayo.eu.elavon.com/gateway/service/vspform-register.vsp';
    } elseif ($processor_data['processor_params']['testmode'] == 'N') {
        $post_address = 'https://live.opayo.eu.elavon.com/gateway/service/vspform-register.vsp';
    } elseif ($processor_data['processor_params']['testmode'] == 'S') {
        $post_address = 'https://sandbox.opayo.eu.elavon.com/Simulator/VSPFormGateway.asp';
    }

...
foreach ($selectable_statuses as $status => $status_name) {
    $item = [
        ...
        'dispatch' => 'static_data.m_update_statuses',
        'data'     => [
            'action_attributes' => [
                'class'               => 'cm-ajax cm-post cm-ajax-send-form',
                'href'                => fn_url('static_data.m_update_statuses?status=' . $status),
                'data-ca-target-id'   => 'static_data_list',
                'data-ca-target-form' => '#static_data_tree_form',
            ],
        ],
        'position' => $position,
    ];

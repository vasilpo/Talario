...
foreach ($selectable_statuses as $status => $status_name) {
    $item = [
        ...
        'dispatch' => 'snippets.m_update_statuses',
        'data'     => [
            'action_attributes' => [
                'class'               => 'cm-ajax cm-post cm-ajax-send-form',
                'href'                => fn_url('snippets.m_update_statuses?status=' . $status),
                'data-ca-target-id'   => 'snippets_form',
                'data-ca-target-form' => '#snippets_form',
            ],
        ],
        'position' => $position,
    ];

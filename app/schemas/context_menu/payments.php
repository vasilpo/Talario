...
foreach ($selectable_statuses as $status => $status_name) {
    $item = [
        ...
        'dispatch' => 'payments.m_update_statuses',
        'data'     => [
            'action_attributes' => [
                'class'               => 'cm-ajax cm-post cm-ajax-send-form',
                'href'                => fn_url('payments.m_update_statuses?status=' . $status),
                'data-ca-target-id'   => 'manage_payments_form',
                'data-ca-target-form' => '#manage_payments_form',
            ],
        ],
        'position' => $position,
    ];

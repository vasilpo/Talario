...
/**
 * Hook handler: Add information about suspended vendors to the "vendors block" on the dashboard
 *
 * @param array<string, array<string, array<array-key, array<string, string|int>>>> $content_data Content information for the "vendors block" on the dashboard
 * @param DashboardBlocks                                                           $dashboard    Information about dashboard blocks and its contents
 *
 * @psalm-param array{
 *       resource_list: array{
 *           content: list<array{
 ...
 * @return void
 */
function fn_vendor_debt_payout_get_dashboard_vendor_with_sales_block_data(array &$content_data, DashboardBlocks $dashboard)
{
    $suspended_vendors_link = 'companies.manage?time_from=' . $dashboard->time_from
        . '&time_to=' . $dashboard->time_to
        . '&get_suspended=' . YesNo::YES;

    $content_data['resource_list']['content'][] = [
        ...
        'href' => $suspended_vendors_link,
        'value' => (int) $dashboard->dashboard_vendors_activity['suspended_vendors'],
        'value_href' => $suspended_vendors_link
    ];
}

/**
 * Hook handler: Add refill form to the "vendor current balance" block on the dashboard
 *
 * @param array<string, string|array<array-key, string>> $content_data Content information for the "vendors block" on the dashboard
 * @param DashboardBlocks                                $dashboard    Information about dashboard blocks and its contents
 *
 * @psalm-param array{
 *       content_tpl?: string[],
 ...
 * @return void
 */
function fn_vendor_debt_payout_get_dashboard_vendor_balance_block_data(array &$content_data, DashboardBlocks $dashboard)
{
    $content_data['content_tpl'] = [
        'addons/vendor_debt_payout/views/vendor_debt_payout/components/refill_balance_form.tpl'
    ];
    $content_data['scripts'] = [
        'js/addons/vendor_debt_payout/func.js'
    ];
}

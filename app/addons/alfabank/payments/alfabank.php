...
if (Alfabank::ENABLE_CALLBACK && $_REQUEST['action'] == 'callback' ) {
$order_id = 0;
$gateway_id = isset($_REQUEST['orderId']) ? $_REQUEST['orderId'] : (isset($_REQUEST['mdOrder']) ? $_REQUEST['mdOrder'] : null);
...
$order_id = explode("_", $response['orderNumber'])[0];
...
$is_part_refunded = $response['paymentAmountInfo']['approvedAmount'] === $response['amount'] && $response['paymentAmountInfo']['refundedAmount'] != 0;
...
if (Alfabank::ENABLE_CALLBACK && $_REQUEST['action'] == 'return' ) {
$order_id = 0;

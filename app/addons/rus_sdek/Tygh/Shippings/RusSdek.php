...
class RusSdek
{
                ...
                if ($count != 0) {
                    ...
                    if ($count == 1) {
                        ...
                        foreach($xml->Pvz as $key => $office) {
                            ...
                            if (isset($office->WeightLimit)) {
                                foreach ($office->WeightLimit->attributes() as $_key => $_value) {
                                    $offices[$code]['weight_limit'][$_key] = (string) $_value;
                                }
                            }
                            if (!isset($office->Dimensions)) {
                                continue;
                            }
                            foreach ($office->Dimensions->attributes() as $_key => $_value) {
                                $offices[$code]['dimensions'][$_key] = (string) $_value;
                            }
                        }
                    }
                }
     ...
     */
    public static function filterOffices(array $offices, array $goods_parameters)
    {

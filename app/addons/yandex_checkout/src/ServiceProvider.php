...
use Tygh\Addons\YandexCheckout\HookHandlers\LoggingHookHandler;
...
use Tygh\Addons\YandexCheckout\Services\OrderService;
...
class ServiceProvider implements ServiceProviderInterface
{
    public function register(Container $app)
    {
        ...
        $app['addons.yandex_checkout.hook_handlers.logs'] = static function (Application $application) {
        ...
        $app['addons.yandex_checkout.order_service'] = static function (Application $application) {
    ...
    /**
     * @return \Tygh\Addons\YandexCheckout\Services\OrderService
     */
    public static function getOrderService()
    {
        return Tygh::$app['addons.yandex_checkout.order_service'];
    }
}
...
namespace Tygh\Addons\YandexCheckout\Payouts;
...
class PayoutsManager
{
     ...
     * @param bool                $can_collect_commission
     * @param \Tygh\VendorPayouts $manager
     */
    ...
    {
        $pending_payouts = $this->manager->getSimple(
            [
    ...
    public function getOrderFee($order_id)
    {
        ...
        $fee = $commission['commission_type'] == 'P'

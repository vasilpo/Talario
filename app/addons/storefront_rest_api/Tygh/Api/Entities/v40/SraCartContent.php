...
class SraCartContent extends ASraEntity
{
    ...
    public function index($id = '', $params = [])
    {
        ...
        $cart = $this->get($cart_service_id, $lang_code);
    ...
    public function create($params)
    {
        ...
        if ($cart_products) {
            ...
            $result = $this->updateProducts($cart_products, self::PRODUCT_ACTION_ADD, $lang_code);
            if ($result->isSuccess()) {
    ...
    public function update($id = '', $params = [])
    {
        ...
        if ($can_edit) {
            ...
            if ($cart_products) {
                $result = $this->updateProducts($cart_products, self::PRODUCT_ACTION_UPDATE, $lang_code);
    ...
    /**
     * @param array{product_id: int, amount: int, propduct_options: array{option_id: int}} $cart_products Cart products
     * @param string                                                                       $action        Product action
     * @param string                                                                       $lang_code     Language code
     *
     * @return \Tygh\Common\OperationResult
     */
    protected function updateProducts(array $cart_products, $action = self::PRODUCT_ACTION_ADD, $lang_code = DEFAULT_LANGUAGE)
    {
        $product_cart_ids = [];
        ...
        foreach ($cart_products as $group) {
            $cart = $this->get($group['cart_service_id'], $lang_code);

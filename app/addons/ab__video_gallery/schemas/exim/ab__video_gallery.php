...
'post_processing' => [
'process_autoplay' => [
'function' => 'fn_ab__vg_exim_process_autoplay',
'args' => ['$import_data'],
'import_only' => true,
]
],
...
'Show in list' => [
'db_field' => 'show_in_list',
],
'Image' => [
'db_field' => 'image_id',
'table' => 'images_links',
'process_get' => ['fn_exim_export_image', '#this', 'ab__vg_video'],
'process_put' => ['fn_exim_import_images', '', '#this', '', '0', ImagePairTypes::MAIN, '#key', 'ab__vg_video']
],
],
];
return $schema;

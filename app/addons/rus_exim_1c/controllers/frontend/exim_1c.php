...
$working_dir_name = '1C_' . date(RusEximCommerceml::$dir_name_date_format);
$root_path = fn_get_files_dir_path() . 'exim/';
$path = $root_path . $working_dir_name . '/';
...
if ($type == 'catalog') {
    if ($mode == 'checkauth') {
        ...
        fn_rus_exim_1c_cleanup_files_dir(
            $root_path,
            $working_dir_name
        );

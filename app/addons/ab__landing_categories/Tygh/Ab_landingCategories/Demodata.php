...
"file_{$img_text}detailed" => [fn_get_files_dir_path() . self::$path_part . $category['main_img']],
...
"file_{$img_text}_icon" => [fn_get_files_dir_path() . self::$path_part . $category['lc-img']],

...
'ab__dotd_enable_countdown_timer' => [
'type' => 'checkbox',
'default_value' => 'Y',
],
],
...
$schema['product_filters']['cache']['request_handlers'][] = 'cid';
...
$schema['product_filters']['content']['items']['fillings']['manually']['params']['request']['cid'] = '%CID%';
...
$schema['main']['cache_overrides_by_dispatch']['products.view']['update_handlers'][] = 'ab__dotd';
$schema['ab__promotion_categories_filter'] = [
'show_on_locations' =>['promotions.view'],
'content' => [
'categories' => [
'type' => 'function',
...
'templates' => [
'addons/ab__deal_of_the_day/blocks/ab__promotion_categories_filter.tpl' => [],
],
'wrappers' => 'blocks/wrappers',
'cache' => [
'update_handlers' => [
...
'request_handlers' => ['promotion_id', 'cid'],
'cookie_handlers' => ['%ALL%'],
'callable_handlers' => [
'date' => ['date', ['Y-m-d-H']],
],

...
function fn_ab__dotd_add_db_fields()
{
$objects = array(
array(
'table' => '?:ab__dotd',
'field' => 'show_label_in_products_lists',
'sql' => 'ALTER TABLE ?:ab__dotd ADD show_label_in_products_lists CHAR(1) NOT NULL DEFAULT \'Y\'',
),
array(
'table' => '?:ab__dotd',
'field' => 'show_in_products_lists',
'sql' => 'ALTER TABLE ?:ab__dotd ADD show_in_products_lists CHAR(1) NOT NULL DEFAULT \'Y\'',
),
array(
'table' => '?:ab__dotd',
'field' => 'show_counter_on_promotion_page',
'sql' => 'ALTER TABLE ?:ab__dotd ADD show_counter_on_promotion_page CHAR(1) NOT NULL DEFAULT \'Y\'',
),
array(
'table' => '?:ab__dotd',
'field' => 'show_counter_on_product_page',
'sql' => 'ALTER TABLE ?:ab__dotd ADD show_counter_on_product_page CHAR(1) NOT NULL DEFAULT \'Y\'',
),
array(
'table' => '?:ab__dotd',
'field' => 'group_by_category',
'sql' => 'ALTER TABLE ?:ab__dotd ADD group_by_category CHAR(1) NOT NULL DEFAULT \'N\'',
),
);

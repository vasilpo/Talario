...
/**
 * Hook handler: add the email marketing subscription form to the list of objects that can require image verification.
 *
 * @param array<string> $objects Objects that can require image verification
 *
 * @return void
 */
function fn_email_marketing_settings_variants_image_verification_use_for(array &$objects)
{
    $objects['email_marketing'] = __('email_marketing.use_for_subscribe_form');
}

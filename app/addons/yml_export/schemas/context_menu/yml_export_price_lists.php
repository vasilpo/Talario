        ...
        'actions' => [
            ...
            'items'    => [
                'delete_selected'   => [
                    ...
                    'dispatch' => 'yml.m_delete_price_lists',
                    'data'     => [
...
foreach ($selectable_statuses as $status => $status_name) {
    $item = [
        ...
        'dispatch' => 'yml.m_update_statuses',
        'data'     => [
            'action_attributes' => [
                'class'               => 'cm-ajax cm-post cm-ajax-send-form',
                'href'                => fn_url('yml.m_update_statuses?status=' . $status),
                'data-ca-target-id'   => 'yml_export_price_lists_form',
                'data-ca-target-form' => '#yml_export_price_lists_form',
            ],
        ],
        'position' => $position,
    ];

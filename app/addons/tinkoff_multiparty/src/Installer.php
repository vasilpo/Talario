...
class Installer implements InstallerInterface
{
    ...
    {
        $processor = [
            'processor'        => 'T-Bank Multiparty',
            'processor_script' => 'tinkoff_multiparty.php',
            'admin_template'   => 'tinkoff_multiparty.tpl',
            'callback'         => YesNo::YES,
            'type'             => 'P',
            'position'         => 10,
            'addon'            => 'tinkoff_multiparty',
        ];
    ...
    public function onUninstall()
    {
        ...
        db_query('DELETE FROM ?:payment_processors WHERE addon = ?s', 'tinkoff_multiparty');
    }
}

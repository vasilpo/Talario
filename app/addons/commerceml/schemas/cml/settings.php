...
$schema = [
    ...
    'catalog_importer.use_product_variation_name_from' => [
        'type' => 'enum',
        'variants' => [
            'automatically',
            'import',
    ...
    'catalog_importer.sync_feature_names' => [
        'type' => 'enum',
        'variants' => [
            'internal',
            'both',
        ...
        'default' => static function ($company_id) {
            return ServiceProvider::isProductFeaturesManageAllowed($company_id) ? 'internal' : 'no';
        },
        'editable' => static function ($company_id) {
            return ServiceProvider::isProductFeaturesManageAllowed($company_id);
        },
    ],
    'catalog_importer.sync_feature_variant_names' => [
        'type' => 'enum',
        'variants' => [
            'yes',
            'no'
        ...
        'default' => static function ($company_id) {
            return ServiceProvider::isProductFeaturesManageAllowed($company_id) ? 'yes' : 'no';
        },
        'editable' => static function ($company_id) {
            return ServiceProvider::isProductFeaturesManageAllowed($company_id);
        },
    ...
    'orders_exporter.strategy' => [
        ...
        'default' => OrderFormator::STRATEGY_NEW,
    ],
    ...
    'orders_importer.payment_date_status' => [
        'type'    => 'string'
    ],
    'orders_importer.shipment_date_status' => [
        'type'    => 'string'
    ]
];

...
class CatalogImportTest extends StorageBasedTestCase
{
    protected function setUp(): void
    {
        ...
        if (!Tygh::$app->has('addons.commerceml.repository.import_repository')) {
            Tygh::$app['addons.commerceml.repository.import_repository'] = static function (Container $app) {
                return new TestImportRepository();
            };
        }
    ...
    public function testImportFeature()
    {
        ...
        $this->assertArrayHasKey('Характеристика без вариантов', $product_storage->getProductFeatureMap());
        ...
        $this->assertArrayNotHasKey('Характеристика без вариантов', $product_storage->getProductFeatureMap());
        ...
        $this->assertArrayHasKey('Характеристика без вариантов', $feature_map);
        ...
        $this->assertArrayHasKey('Характеристика без вариантов', $feature_map);
        $this->assertCount(3, $product_storage->products[1]['ru']['product_features']);
    }
    ...
    /**
     * @return \PHPUnit\Framework\MockObject\MockObject|ProductVariationsService
     */
    ...
    /**
     * @return \PHPUnit\Framework\MockObject\MockObject|ProductVariationsGroupRepository
     */

...
class ProductFeatureImporterTest extends StorageBasedTestCase
{
            ...
            [
                1 => [
                    'ru' => [
                        ...
                        'company_id'       => 1,
                        'feature_code'     => 'commerceml_9d67a9cd-baf9-11e6-853e-60a44c5c87dc',
                        'variants'         => [
                            1 => [
                                'variant_id' => '1',
                                'local_id'   => '1',
    ...
    public function testImportByFeatureValue()
    {
        ...
        $selected_feature_values_coll = new ProductFeatureSelectedValueDtoCollection();
        $selected_feature_value = ProductFeatureSelectedValueDto::create('9d67a9d0-baf9-11e6-853e-60a44c5c87dc', IdDto::createByExternalId('9d67a9cd-baf9-11e6-853e-60a44c5c87dc#9d67a9d0-baf9-11e6-853e-60a44c5c87dc'));
        $selected_feature_values_coll->add($selected_feature_value);

        $feature_value = ProductFeatureValueDto::create(
            IdDto::createByExternalId('9d67a9cd-baf9-11e6-853e-60a44c5c87dc'),
            $selected_feature_values_coll
        );
        ...
        $this->assertEquals(3, $feature_value->selected_values->get($selected_feature_value->value_id->getId())->value_id->local_id);
    }

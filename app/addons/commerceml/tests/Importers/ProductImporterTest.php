...
class ProductImporterTest extends StorageBasedTestCase
{
    ...
    public function loadEntities(ImportStorage $import_storage)
    {
        ...
        $product_feature1->is_multiple = true;
        ...
        $product_feature2->is_multiple = true;
        ...
        $product_feature6->is_multiple = true;
        ...
        $variant4 = ProductFeatureVariantDto::create(IdDto::createByExternalId('b9069efe-ca9c-11e7-8576-60a44c5c87dc#b9069efg-ca9c-11e7-8576-60a44c5c87dc'), TranslatableValueDto::create('4'));

...
class ProductVariationImporterTest extends StorageBasedTestCase
{
    ...
    public function testImport()
    {
        ...
        $selected_feature_value = ProductFeatureSelectedValueDto::create(
            TranslatableValueDto::create('Зеленый'),
            IdDto::createByExternalId('28b6895a-24a9-11e0-aeec-0015e9b8c48d#1')
        );
        $selected_feature_values_coll1->add($selected_feature_value);
    ...
    /**
     * @return \PHPUnit\Framework\MockObject\MockObject|Service
     */
    ...
    /**
     * @return \PHPUnit\Framework\MockObject\MockObject|Repository
     */

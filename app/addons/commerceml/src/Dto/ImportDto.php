...
class ImportDto
{
     ...
     *
     * @return array{import_id: int, import_key: string, catalog_id: string, company_id: int, user_id: int, status: string, has_only_changes: string, created_at: int, updated_at: int}
     */
    ...
    public static function fromArray(array $data)
    {
        ...
        $self->catalog_id = isset($data['catalog_id']) ? (string) $data['catalog_id'] : '';

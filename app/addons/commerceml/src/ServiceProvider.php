...
class ServiceProvider implements ServiceProviderInterface
{
     ...
     *
     * @param int $expired_period Expired period in seconds
     *
     * @return void
     */
    public static function clearExpiredEntities($expired_period = 86400)
    {
        db_query('DELETE FROM ?:commerceml_import_entities WHERE updated_at < ?i', TIME - $expired_period);
    }
}

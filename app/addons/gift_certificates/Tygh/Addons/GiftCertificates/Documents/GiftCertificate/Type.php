...
class Type implements IType, IPreviewableType, IIncludableType
{
    ...
    public function includeDocument($code, $lang_code, $params)
    {
        ...
        return $this->renderById($gift_cert_id, $code ?? 'default', $lang_code);
    }
     ...
     *
     * @param array<array-key, string|int> $gift_certificate Gift certificate data.
     * @param string                       $code             Document code.
     * @param string                       $lang_code        Language code.
     *
     * @return string
     */
    public function renderByData(array $gift_certificate, $code, $lang_code)
    {
     ...
     * @return string
     */
    public function renderById($gift_certificate_id, $code, $lang_code)
    {
        $gift_cert_data = fn_get_gift_certificate_info($gift_certificate_id);


        if ($gift_cert_data) {
            return $this->renderByData($gift_cert_data, $code ?? 'default', $lang_code);
        }

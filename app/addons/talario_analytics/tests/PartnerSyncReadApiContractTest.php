...
final class PartnerSyncReadApiContractTest extends TestCase
{
    ...
    public function testPartnerSyncWriteIsInternalCliOnly(): void
    {
        ...
        self::assertStringContainsString('PARTNER_SYNC_ROOT_GROUP_MISMATCH', $this->cli_runner);
    ...
    public function testDevDispatcherHasFixedPartnerSyncCommands(): void
    {
        ...
        self::assertStringContainsString('EXPECTED_RUNNER_SHA256="ab41afcd39cda22a9960f7c5521eff39199ca803a0a1ad83df610a7f8b09b92d"', $this->dev_dispatcher);

...
final class PartnerSyncReadApiContractTest extends TestCase
{
    ...
    public function testPartnerSyncWriteIsInternalCliOnly(): void
    {
        ...
        self::assertStringContainsString("$root . '/config.local.php'", $this->cli_runner);
        self::assertStringContainsString("$root . '/app/addons/talario_analytics/partner_sync_write.php'", $this->cli_runner);
    ...
    public function testDevDispatcherHasFixedPartnerSyncCommands(): void
    {
        ...
        self::assertStringContainsString('EXPECTED_RUNNER_SHA256="6523022efe59f241c198c73ced90f628e298c89954af5f44585d4a77b6498097"', $this->dev_dispatcher);

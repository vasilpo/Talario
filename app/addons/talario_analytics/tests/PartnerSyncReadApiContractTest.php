...
final class PartnerSyncReadApiContractTest extends TestCase
{
    ...
    public function testSignedPenatyApplyUsesIsolatedReviewedCliRunner(): void
    {
        ...
        self::assertStringContainsString("'error_log=/dev/stderr'", $this->controller);
        self::assertStringContainsString("'error_reporting=-1'", $this->controller);
        self::assertStringContainsString('$failure_text', $this->controller);

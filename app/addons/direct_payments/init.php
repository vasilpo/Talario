...
fn_register_hooks(
    'allow_place_order_check_payment',
    'get_route_runtime',
    'get_payments_pre',
    'user_init',
    ...
    'stripe_data_loader_load_payment_request_data_post',
    ...
    'mve_update_order',
    /** @see \fn_master_products_pre_add_to_cart */
    'master_products_pre_add_to_cart_pre'
);

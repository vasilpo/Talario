        ...
        'actions' => [
            ...
            'items'    => [
                'delete_selected'   => [
                    ...
                    'dispatch' => 'buy_together.m_delete',
                    'data'     => [
...
foreach ($selectable_statuses as $status => $status_name) {
    $item = [
        ...
        'dispatch' => 'buy_together.m_update_statuses',
        'data'     => [
            'action_attributes' => [
                'class'               => 'cm-ajax cm-post cm-ajax-send-form',
                'href'                => fn_url('buy_together.m_update_statuses?status=' . $status),
                'data-ca-target-id'   => 'manage_buy_together_form',
                'data-ca-target-form' => '#manage_buy_together_form',
            ],
        ],
        'position' => $position,
    ];

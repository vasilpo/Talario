...
$schema = [
    ...
    'items'               => [
        ...
        'shippings' => [
            'name'     => ['template' => 'shippings'],
            'type'     => ComponentItem::class,
            'template' => 'addons/suppliers/views/suppliers/components/context_menu/shippings.tpl',
            'position' => 30,
        ],
        'actions' => [
...
foreach ($selectable_statuses as $status => $status_name) {
    $item = [
        ...
        'dispatch' => 'suppliers.m_update_statuses',
        'data'     => [
            'action_attributes' => [
                'class'               => 'cm-ajax cm-post cm-ajax-send-form',
                'href'                => fn_url('suppliers.m_update_statuses?status=' . $status),
                'data-ca-target-id'   => 'pagination_contents',
                'data-ca-target-form' => '#suppliers_list_form',
            ],
        ],
        'position' => $position,
    ];

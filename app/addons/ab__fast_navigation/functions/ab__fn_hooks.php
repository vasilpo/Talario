...
function fn_ab__fast_navigation_is_need_watermark_post(&$object_type, $is_detailed, $company_id, &$result)
{
if ($object_type == 'ab__fn_menu_icon' && Registry::ifGet('addons.ab__fast_navigation.add_watermarks', 'N') == 'Y') {
$result = true;
}
}
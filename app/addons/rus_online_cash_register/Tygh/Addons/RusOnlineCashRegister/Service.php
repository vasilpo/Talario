...
use Tygh\Enum\Addons\RusOnlineCashRegister\ExternalPaymentIds;
...
class Service
{
    ...
    {
        $base_receipt = $this->receipt_factory->createReceiptFromOrder($order, $this->currency);
        ...
        $receipt->setPayment(new Payment(
            ExternalPaymentIds::getPaymentId($payment_method),
            $receipt->getTotal())
        );

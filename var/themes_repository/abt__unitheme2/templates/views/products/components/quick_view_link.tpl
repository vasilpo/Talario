...
<a class="ut2-quick-view-button cm-dialog-opener {if !$runtime.customization_mode.live_editor}cm-tooltip{/if} cm-dialog-auto-size" title="{__("quick_view")}" data-ca-view-id="{$product.product_id}" data-ca-target-id="product_quick_view" href="{$quick_view_url|fn_url}" data-ca-dialog-title="{__("quick_product_viewer")}" rel="nofollow"><i class="ut2-icon-baseline-visibility_line"><span class="path1"></span><span class="path3"></i></a>
{/ab__hide_content}
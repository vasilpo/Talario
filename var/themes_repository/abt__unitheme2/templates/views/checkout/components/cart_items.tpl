                        ...
                        <td class="ty-cart-content__product-elem ty-cart-content__description">
                            <div class="abt__ut2--content__description__in">
                                ...
                                {if $product.product_code|trim}
                                    <div class="ty-control-group ty-cart-content__sku ty-sku-item cm-hidden-wrapper" id="sku_{$key}">
                                        <label class="ty-control-group__label" id="sku_387">{__("sku")}:</label>
                                        <span class="cm-reload-{$obj_prefix}{$obj_id} ut2_copy" title="{__("copy")}" id="product_code_{$obj_prefix}{$obj_id}">

        ...
        <div class="ty-product-filters__block">
            ...
            <div class="ty-product-filters {if $collapse}hidden{/if}" id="content_{$filter_uid}">
                ...
                <div class="ty-product-filters__tools clearfix">
                    ...
                    <a href="{"companies.catalog"|fn_url}" rel="nofollow" class="ty-btn ty-product-filters__reset-button"><i class="ty-product-filters__reset-icon ty-icon-cw"></i>{__("reset")}</a>
                </div>
            </div>
        </div>
    </div>

...
{if $product_review}
    <div class="ty-product-review-post-votes" id="product_review-post_votes_{$product_review_id}{$id_postfix}">
        {include
            file="buttons/button.tpl"
            but_id=$product_review_id|cat:$id_postfix
            ...
            but_role="submit"
            but_target_id="product_review-post_votes_`$product_review_id`,product_review-post_votes_`$product_review_id`*"
    ...
    <!--product_review-post_votes_{$product_review_id}{$id_postfix}--></div>
{/if}

...
{if $settings.ab__device !== "mobile"}
    ...
    <div class="ut2-pb ty-product-block ut2-big-image --gallery{if $product_images_count > 1} --three{elseif $product_images_count == 1} --double{else} --single{/if}" style="--pd-image-gallery-width: {$pd_image_gallery_width};--pd-image-gallery-height: {$pd_image_gallery_height}">

                    ...
                    {capture name="promotion_info_popup_opener"}
                        <div class="ab__dotd_promotion {if $promotion.ab__dotd_expired}action-is-over{/if}">
                            <div class="row-fluid ab__dotd_promotion-main_info">
                                {if $promotion.image}
                                    <div class="span7 ab__dotd_promotion-image" style="aspect-ratio: 2/1.2;background-size: 100%;background-repeat: no-repeat;background-image: url('{$promotion.image.icon.image_path}');">
                                    </div>
                                {/if}
                                <div class="span9">

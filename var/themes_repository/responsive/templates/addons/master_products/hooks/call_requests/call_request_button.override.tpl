{if $product.master_product_id || !$product.company_id}
    {$buy_now_but_meta_with_popup = $buy_now_but_meta_with_popup|default:"ty-btn ty-btn__text ty-cr-product-button cm-dialog-destroy-on-close"}
    {$buy_now_but_meta_simple = $buy_now_but_meta_simple|default:"btn ty-btn ty-btn__text ty-cr-product-button"}

...
{assign var="reward_points_tooltip" value=__("reward_points_tooltip")}
{if $reward_points_tooltip|trim}
    <div class="ty-reward-points__tooltip">{$reward_points_tooltip}</div>
{/if}

        ...
        <form name="order_register_form" action="{""|fn_url}" method="post">
            ...
            <div class="ty-control-group">
                ...
                <div class="exikane-password-wrap">
                    <input type="password" id="password1" name="user_data[password1]" size="32" maxlength="32" value="" class="cm-autocomplete-off ty-login__input" data-ca-password-toggle-field="true" />
            ...
            <div class="ty-control-group">
                ...
                <div class="exikane-password-wrap">
                    <input type="password" id="password2" name="user_data[password2]" size="32" maxlength="32" value="" class="cm-autocomplete-off ty-login__input" data-ca-password-toggle-field="true" />
                    <button type="button" class="exikane-password-toggle cm-exikane-password-toggle" aria-label="{__("exikane_changes.show_password")}" aria-pressed="false">
                        <i class="ty-icon-eye-open"></i>
                    </button>
                </div>

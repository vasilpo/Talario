...
<div class="ty-bookings-page">
    <div class="ty-bookings-page__header">
        <h1 class="ty-bookings-page__title">{__("exikane_changes.my_bookings")}</h1>
        <p class="ty-bookings-page__subtitle">{__("exikane_changes.bookings_subtitle")}</p>
    </div>

    <form action="{"orders.search"|fn_url}" class="ty-bookings-filters" method="get" name="exikane_bookings_search_form">
        ...
        <label class="ty-bookings-filters__group" for="elm_bookings_sort_filter">
            <span class="ty-bookings-filters__label">{__("exikane_changes.sorting")}:</span>
            <select id="elm_bookings_sort_filter" class="ty-bookings-filters__select" name="sort_token">
                <option value="date_asc" {if $selected_sort === "date_asc"}selected="selected"{/if}>{__("exikane_changes.sort_nearest_first")}</option>
                <option value="date_desc" {if $selected_sort === "date_desc"}selected="selected"{/if}>{__("exikane_changes.sort_latest_first")}</option>
                <option value="total_desc" {if $selected_sort === "total_desc"}selected="selected"{/if}>{__("exikane_changes.sort_total_desc")}</option>
                <option value="total_asc" {if $selected_sort === "total_asc"}selected="selected"{/if}>{__("exikane_changes.sort_total_asc")}</option>
                <option value="order_id_desc" {if $selected_sort === "order_id_desc"}selected="selected"{/if}>{__("exikane_changes.sort_id_desc")}</option>
            </select>
        </label>
        ...
        <label class="ty-bookings-filters__search" for="elm_bookings_query">
            <input
                ...
                type="text"
                value="{$search_query}"
                placeholder="{__("exikane_changes.search_booking_placeholder")}" />
            <button
            ...
            <article class="ty-bookings-card">
                <div class="ty-bookings-card__main">
                    <h2 class="ty-bookings-card__title">
                        <a href="{"orders.details?order_id=`$o.order_id`"|fn_url}">{$o.exikane_booking_product_name}</a>
                    </h2>

                    {if $o.exikane_booking_address}
                        <div class="ty-bookings-card__meta-item ty-bookings-card__meta-item--address">
                            ...
                            <span>{$o.exikane_booking_address}</span>
                        </div>
                    {/if}

                    {if $o.exikane_booking_age}
                        <div class="ty-bookings-card__meta-item">
                            <i class="ut2-icon-outline-account-circle ty-bookings-card__meta-icon"></i>
                            <span class="ty-bookings-card__meta-label">{__("exikane_changes.booking_age")}:</span>
                            <span>{$o.exikane_booking_age}</span>
                        </div>
                    {/if}
                </div>
                ...
                <div class="ty-bookings-card__details">
                    ...
                    {if $o.exikane_booking_type}
                        <div class="ty-bookings-card__type">
                            <span class="ty-bookings-card__type-label">{__("exikane_changes.booking_type")}:</span>
                            <span class="ty-bookings-card__type-value">{$o.exikane_booking_type}</span>
                        </div>
                    {/if}
                    ...
                    <div class="ty-bookings-card__totals">
                        <div class="ty-bookings-card__totals-row">
                            <span class="ty-bookings-card__totals-label">{__("exikane_changes.booking_cost")}:</span>
                            <span class="ty-bookings-card__totals-value">{include file="common/price.tpl" value=$o.exikane_products_total}</span>
                        </div>
                        <div class="ty-bookings-card__totals-row">
                            <span class="ty-bookings-card__totals-label ty-bookings-card__totals-label--accent">{__("exikane_changes.points_spent")}:</span>
                            <span class="ty-bookings-card__totals-value ty-bookings-card__totals-value--accent">{include file="common/price.tpl" value=$o.exikane_points_cost}</span>
                        </div>
                        <hr class="ty-bookings-card__totals-divider" />
                        <div class="ty-bookings-card__totals-row">
                            <span class="ty-bookings-card__totals-label">{__("exikane_changes.total_paid")}:</span>
                            <span class="ty-bookings-card__totals-value">{include file="common/price.tpl" value=$o.exikane_paid_total}</span>
                        </div>
                    </div>
                </div>

                <div class="ty-bookings-card__actions">
                    <a class="ty-btn ty-btn__primary" href="{"orders.details?order_id=`$o.order_id`"|fn_url}">{__("exikane_changes.open_details")}</a>
                </div>
            </article>
        {foreachelse}

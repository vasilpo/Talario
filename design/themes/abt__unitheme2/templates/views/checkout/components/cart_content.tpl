...
<div class="buttons-container ut2-cart-content__top-buttons clearfix">
    <div class="ut2-cart-content__left-buttons">
        {hook name="checkout:cart_content_top_left_buttons"}
            {include file="buttons/continue_shopping.tpl" but_href=$continue_url|fn_url }
        {/hook}
    </div>
    <div class="ut2-cart-content__right-buttons">
...
<div class="buttons-container ut2-cart-content__bottom-buttons clearfix">
    <div class="ut2-cart-content__left-buttons">

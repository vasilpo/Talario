...
{assign scope='parent' var='show_features' value=$settings.abt__ut2.product_list.$tmpl.grid_item_bottom_content[$settings.ab__device] === "features"}
...
{assign scope='parent' var='show_product_options' value=$settings.abt__ut2.product_list.$tmpl.show_options[$settings.ab__device] === "YesNo::YES"|enum}

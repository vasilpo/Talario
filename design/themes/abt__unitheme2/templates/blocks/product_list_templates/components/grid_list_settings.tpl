...
{if $settings.abt__ut2.product_list.price_position_top === "YesNo::YES"|enum}
    {$thc = $t2|default:0 + $t3|default:0 + $t4|default:0 + $t5|default:0 + $t7|default:0 + $t10|default:0 + $t11|default:0 + $t12|default:0 + $pd}
{else}
    {$thc = $t2|default:0 + $t3|default:0 + $t4|default:0 + $t5|default:0 + $t7|default:0 + $t10|default:0 + $t11|default:0 + $t12|default:0 + $pth + $pd}
{/if}

...
{script src="js/tygh/backend/notifications_center_background.js"}

{if $smarty.const.AREA !== "SiteArea::STOREFRONT"|enum && $backoffice_color_scheme === "BackofficeColorSchemeVariants::SYSTEM"|enum}
    {script src="js/tygh/backend/system_color_scheme_identifier.js"}
{/if}

<fieldset>
    ...
    <div id="commerceml_additional_settings" class="out collapse">
        ...
        <div class="control-group setting-wide">
            <label class="control-label" for="elm_sync_data_commerceml_cml_catalog_use_product_variation_name_from">{__("commerceml.cml_catalog_use_product_variation_name_from")}:<div class="muted description">{__("commerceml.cml_catalog_use_product_variation_name_from.tooltip")}</div></label>
            <div class="controls">
                {foreach $settings_schema["catalog_importer.use_product_variation_name_from"].variants as $variant}
                    <label class="radio">
                        <input
                            type="radio"
                            value="{$variant}" name="sync_data_settings[{$sync_provider_id}][catalog_importer.use_product_variation_name_from]"
                            {if $import_settings["catalog_importer.use_product_variation_name_from"] == $variant}checked="checked"{/if}
                        >
                        {__("commerceml.cml_catalog_use_product_variation_name_from.{$variant|lower}")}
                        <p class="muted">
                            {__("commerceml.cml_catalog_use_product_variation_name_from.{$variant|lower}.tooltip")}
                        </p>
                    </label>
                {/foreach}
            </div>

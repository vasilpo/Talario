...
{** Desc of a item **}
<div class="control-group">
<label for="abt__ut2_mwi__desc_{$id}" class="control-label">{__("abt__ut2.menu_with_icons.desc")}{include file="common/tooltip.tpl" tooltip=__("abt__ut2.menu_with_icons.desc.tooltip")}:</label>
<div class="controls">
...
{** Type of a item **}
<div class="control-group">
<label for="abt__ut2_mwi__dropdown_{$id}" class="control-label">{__("abt__ut2.menu_with_icons.dropdown")}{include file="common/tooltip.tpl" tooltip=__("abt__ut2.menu_with_icons.dropdown.tooltip")}:</label>
<div class="controls">
...
{** text **}
<div class="control-group">
<label for="abt__ut2_mwi__text_{$id}" class="control-label">{__("abt__ut2.menu_with_icons.text")}{include file="common/tooltip.tpl" tooltip=__("abt__ut2.menu_with_icons.text.tooltip")}:</label>
<div class="controls">
...
{** label **}
<div class="control-group">
<label for="abt__ut2_mwi__label_{$id}" class="control-label">{__("abt__ut2.menu_with_icons.label")}{include file="common/tooltip.tpl" tooltip=__("abt__ut2.menu_with_icons.label.tooltip")}:</label>
<div class="controls">

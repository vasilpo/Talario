...
<th width="40%%">{__("variant")}</th>
<th width="35%" class="js-feature-variant-conditional-column" data-ca-column-for-feature-style="color" data-ca-column-for-filter-style="color">{__("abt__ut2.variant_color_style")}</th>
{/hook}
<th>&nbsp;</th>
<th>&nbsp;</th>
</tr>
...
<td width="30%" data-th="{__("variant")}" data-type="{$var.abt__ut2_color_style}">

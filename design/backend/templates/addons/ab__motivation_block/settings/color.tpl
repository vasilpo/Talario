...
<div class="controls">
{if !$disable_input}
{include file="views/theme_editor/components/colorpicker.tpl" cp_name="addon_data[options][{$ab__mb_bg_color_setting.object_id}]" cp_id="addon_option_ab__motivation_block_bg_color" cp_value=$ab__mb_bg_color_setting.value|default:'#FFFFFF'}
{else}

        ...
        <div class="modal-body">
            ...
            <div class="control-group">
                ...
                <div class="exikane-password-wrap">
                    <input class="signin-modal__form-field" type="password" id="password" name="password" size="20" value="{$config.demo_password}" tabindex="2" maxlength="32" data-ca-password-toggle-field="true">

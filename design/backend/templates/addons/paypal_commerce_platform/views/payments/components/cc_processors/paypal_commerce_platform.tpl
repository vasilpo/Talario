...
<div class="control-group">
    <label for="elm_send_shipping_address{$suffix}"
           class="control-label"
    >{__("paypal_commerce_platform.send_shipping_address")}:</label>
    <div class="controls">
        <input type="hidden"
        ...
        <input type="checkbox"
               ...
               value="{"YesNo::YES"|enum}"
        />
        <div class="paypal-commerce-platform-config-form__send_shipping_address">
            {__("paypal_commerce_platform.send_shipping_address_tooltip")}
        </div>
    </div>
</div>

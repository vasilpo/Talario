{if isset($order_info.payment_method.processor_params.is_paypal_commerce_platform)
    ...
    <div class="control-group">
        ...
        <div class="controls">
            <input type="checkbox"
                   id="paypal_commerce_platform_send_shipment_info_{$shipping.group_key}_{$shipment.shipment_id}"
                   name="update_shipping[{$shipping.group_key}][{$shipment.shipment_id}][paypal_commerce_platform_send_shipment_info]"

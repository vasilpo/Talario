...
<div class="control-group">
<label class="control-label" for="elm_ab__dotd_group_by_category">{__("ab__dotd.form.group_by_category")}:</label>
<div class="controls">
<input type="hidden" name="promotion_data[group_by_category]" value="N" />
<input type="checkbox" name="promotion_data[group_by_category]" id="elm_ab__dotd_group_by_category" value="Y" {if $promotion_data.group_by_category == "Y"}checked="checked"{/if} />
</div>
</div>
<div class="control-group">
<label class="control-label">{__("ab__dotd.main_category_filter_icon")}:</label>
<div class="controls">
{include file="common/attach_images.tpl"
image_name="ab__dotd_m_cat_filter"
image_object_type="ab__dotd_m_cat_filter"
image_key=$id
hide_titles=true
no_detailed=true
hide_alt=true
image_pair=$promotion_data.ab__dotd_m_cat_filter}
</div>
</div>
<div class="control-group">
...
{if $promotion_data.zone|default:$zone === "catalog"}
<div class="control-group">
<label class="control-label" for="elm_show_label_in_products_lists">{__("ab__dotd.form.show_label_in_products_lists")}:</label>
<div class="controls">
<input type="hidden" name="promotion_data[show_label_in_products_lists]" value="N" />
<input type="checkbox" name="promotion_data[show_label_in_products_lists]" id="elm_show_label_in_products_lists" value="Y" {if $promotion_data.show_label_in_products_lists != "N"}checked="checked"{/if} />
</div>
</div>
<div class="control-group">
<label class="control-label" for="elm_show_in_products_lists">{__("ab__dotd.form.show_in_products_lists")}:</label>
<div class="controls">
<input type="hidden" name="promotion_data[show_in_products_lists]" value="N" />
<input type="checkbox" name="promotion_data[show_in_products_lists]" id="elm_show_in_products_lists" value="Y" {if $promotion_data.show_in_products_lists != "N"}checked="checked"{/if} />
</div>
</div>
<div class="control-group">
<label class="control-label" for="elm_show_counter_on_product_page">{__("ab__dotd.form.show_countdown_on_product_page")}:</label>
<div class="controls">
<input type="hidden" name="promotion_data[show_counter_on_product_page]" value="N" />
<input type="checkbox" name="promotion_data[show_counter_on_product_page]" id="elm_show_counter_on_product_page" value="Y" {if $promotion_data.show_counter_on_product_page != "N"}checked="checked"{/if} />
</div>
</div>
{/if}
<div class="control-group">
<label class="control-label" for="elm_show_counter_on_promotion_page">{__("ab__dotd.form.show_countdown_on_promotion_page")}:</label>
<div class="controls">
<input type="hidden" name="promotion_data[show_counter_on_promotion_page]" value="N" />
<input type="checkbox" name="promotion_data[show_counter_on_promotion_page]" id="elm_show_counter_on_promotion_page" value="Y" {if $promotion_data.show_counter_on_promotion_page != "N"}checked="checked"{/if} />
</div>
</div>

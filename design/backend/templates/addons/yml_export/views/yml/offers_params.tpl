...
{capture name="buttons"}
    {include file="buttons/save.tpl" but_name="dispatch[yml.update_offers]" but_role="submit-link" but_target_form="yml_export_offers" but_meta="nav__actions-btn-save"}
{/capture}

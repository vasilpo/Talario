{assign var=price_wise  value=($product_data.price_wise)}
	...
	<table class="table table-middle" width="100%">
		...
		<tbody>
				...
				{foreach from=$price_wise  key="key" item="item"}
					...
					<tr class="cm-row-item" id="box_book_slot{$id}">
						<td>
                            ...
                            start_date_value_name="product_data[booking_data][R][price_wise][{$id}][from_date]"
                            end_date_value_name="product_data[booking_data][R][price_wise][{$id}][to_date]"}
						</td>
						<td>
							<input type="text" class="input-small" name="product_data[booking_data][R][price_wise][{$id}][price]" value="{$item.price}" />
						</td>
						<td class="right">
			...
			<tr class="cm-row-item" id="box_book_slot{$id}">
				...
				<td>
					<input type="text" class="input-small" name="product_data[booking_data][R][price_wise][{$id}][price]" value="" />
				</td>
				<td class="right">

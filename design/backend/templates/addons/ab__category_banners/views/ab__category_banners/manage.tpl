...
<form action="{""|fn_url}" method="post" name="category_banners_form" id="category_banners_form" class="form-horizontal{if ""|fn_check_form_permissions} cm-hide-inputs{/if}">
...
input_name="category_banners_data[{$category_banner.category_banner_id}][from_time]"
id="elm_from_time_{$category_banner.category_banner_id}"
time=$category_banner.from_date
}
</td>
<td>
...
{include file="addons/ab__category_banners/views/ab__category_banners/components/time.tpl"
input_name="category_banners_data[{$category_banner.category_banner_id}][to_time]"
id="elm_to_time_{$category_banner.category_banner_id}"
time=$category_banner.to_date
}
</td>
<td>

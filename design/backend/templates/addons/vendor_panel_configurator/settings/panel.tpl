<div id="vendor_panel_config">
    ...
    <div class="control-group">
        ...
        <div class="controls">
            {include file="common/attach_images.tpl"
                ...
                image_object_id="\Tygh\Addons\VendorPanelConfigurator\Enum\ImagePairObjectIds::BACKGROUD_IMAGE"|constant
                no_detailed=true
                hide_titles=true
                hide_alt=true
            }
    ...
    <div class="control-group">
        <label class="control-label">{__("vendor_panel_configurator.logo")}</label>
        <div class="controls">
            {include file="common/attach_images.tpl"
                image_name="logo"
                image_object_type="vendor_panel"
                image_pair=$vendor_panel.logo
                image_object_id="\Tygh\Addons\VendorPanelConfigurator\Enum\ImagePairObjectIds::LOGO"|constant
                no_detailed=true
                hide_titles=true
                hide_alt=true
            }
    ...
    <div class="control-group">
        <label class="control-label">{__("vendor_panel_configurator.logo_dark")}</label>
        <div class="controls">
            {include file="common/attach_images.tpl"
                image_name="logo_dark"
                image_object_type="vendor_panel"
                image_pair=$vendor_panel.logo_dark
                image_object_id="\Tygh\Addons\VendorPanelConfigurator\Enum\ImagePairObjectIds::LOGO_DARK"|constant
                no_detailed=true
                hide_titles=true
                hide_alt=true
            }
            <p class="muted description">{__("vendor_panel_configurator.logo_dark_description")}</p>
        </div>
    </div>

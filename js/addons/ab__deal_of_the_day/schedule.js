...
$.ceEvent('on', 'ce.tab.show', (tab_id, tabs_elm) => {
if (tab_id === 'ab__dotd_schedule' && !tabs_elm.data('ab__dotd_timesheeds_inited')) {
tabs_elm.data('ab__dotd_timesheeds_inited', true);
